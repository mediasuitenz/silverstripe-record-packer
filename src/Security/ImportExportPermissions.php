...
/**
 * Gates PackableExtension/RecordPackerController for a plain project DataObject — the record-
 * packer-pages module registers its own SiteTreeImportExportPermissions alongside this one, so a
 * group can be granted export/import on generic records without also being granted it on pages
 * (or vice versa).
 */
